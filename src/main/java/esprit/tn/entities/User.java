...
public User( String nom,Role role, String prenom, String email, String mdp, String adresse, Sexe sexe, String imageProfil, Status status, Double salaireAttendu, String poste, Double salaire, int experienceTravail, String departement, String competence, int nombreProjet, Double budget, String departementGere, int ansExperience, String specialisation) {
    ...
    public User( String nom,Role role, String prenom, String email, String mdp, String adresse, Sexe sexe, String imageProfil, Status status, Double salaireAttendu, String poste, Double salaire, int experienceTravail, String departement, String competence, int nombreProjet, Double budget, String departementGere, int ansExperience, String specialisation , String telephone) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
        this.mdp = mdp;
    ...
    public User(String nom, String prenom, String email, String mdp, String adresse, String imageProfil, String poste, String departement, String competence, String departementGere, String specialisation, String telephone) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
        this.mdp = mdp;
