...
public class DashboardHR {
    ...
    private Button btnChangeProfile11;
    @FXML
    private VBox quoteContainer; // Ajout du conteneur pour la citation (inutilisé ici)
    ...
    public void initialize() throws SQLException {
        ...
        // Afficher le popup de la citation
        showQuotePopup();
    }
    ...
    private void showQuotePopup() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Quote.fxml"));
            Parent root = loader.load();
